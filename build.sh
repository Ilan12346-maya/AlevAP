...
# Config
PACKAGE_NAME="com.alevde"
ACTIVITY_NAME="com.alevde.MainActivity"
# Since splits are enabled, the APK name might vary. We'll search for it.
FINAL_APK="alevde_debug.apk"
ADB="$PREFIX/bin/adb"
...
# Start Build Process
echo -e "${BOLD}Starting Alevde Build Process${NC}"
