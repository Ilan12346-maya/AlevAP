package com.alevde.utils;

import static com.alevde.shared.termux.extrakeys.ExtraKeysConstants.PRIMARY_KEY_CODES_FOR_STRINGS;
import static com.alevde.MainActivity.toggleKeyboardVisibility;
...
import com.alevde.shared.termux.extrakeys.*;
import com.alevde.LoriePreferences;
import com.alevde.MainActivity;
...
public class TermuxX11ExtraKeys implements ExtraKeysView.IExtraKeysView {
    ...
    static final String ACTION_START_PREFERENCES_ACTIVITY = "com.alevde.start_preferences_activity";
