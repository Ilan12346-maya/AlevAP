...
import static com.alevde.CmdEntryPoint.ACTION_START;
import static com.alevde.LoriePreferences.ACTION_PREFERENCES_CHANGED;
...
import com.alevde.input.InputEventSender;
import com.alevde.input.InputStub;
import com.alevde.input.TouchInputHandler;
import com.alevde.utils.FullscreenWorkaround;
import com.alevde.utils.KeyInterceptor;
import com.alevde.utils.SamsungDexUtils;
import com.alevde.utils.TermuxX11ExtraKeys;
import com.alevde.utils.X11ToolbarViewPager;
...
public class MainActivity extends AppCompatActivity {
    public static final String ACTION_STOP = "com.alevde.ACTION_STOP";
    public static final String ACTION_CUSTOM = "com.alevde.ACTION_CUSTOM";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.help_button).setOnClickListener((l) -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/alevde/alev"))));
    ...
    private void setupDebugInfo() {
        ...
        copyButton.setOnClickListener(v -> {
            ...
            android.content.ClipData clip = android.content.ClipData.newPlainText("Alevde Debug Info", debugText.getText());
    ...
    private void createServerScript() {
        ...
        String stopContent = "#!/system/bin/sh\n" +
                "PID=$(pidof com.alevde.CmdEntryPoint)\n" +
                "if [ -n \"$PID\" ]; then\n" +
                "  kill $PID\n" +
        ...
        for (String bin : binaries) {
            ...
            if (wrapperFile.exists()) {
                try {
                    ...
                    if ((bin.equals("sh") || bin.equals("bash")) && out != null && out.contains("ALEVDE-OK")) {
            ...
            private void addFloatingCopyButton(final TextView debugText) {
                runOnUiThread(() -> {
                    ...
                    btn.setOnClickListener(v -> {
                        android.content.ClipboardManager clipboard = (android.content.ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
                        android.content.ClipData clip = android.content.ClipData.newPlainText("Alevde Logs", debugText.getText());
                        clipboard.setPrimaryClip(clip);
